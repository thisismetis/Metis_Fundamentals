...
We highly recommend that you check out the [walkthrough video](https://youtu.be/x2yiIyRWWy8) that accompanies these instructions! ((reach out to X if you need access to the google drive)
